...
import '../comp_css_theme/brown_theme.css'
...
const Theme_brown = () => {
  ...
  return (
    <>
      <div className="cv-container-brown "  id='myDiv'>
        <div className="cv-section-brown  text-justify-start">
          ...
          <img src="../public/profile.png"  style={{width:"100px", height:"100px",borderRadius:"50%"}}className='border'/>}
          <h2 className="cv-title">{thisUser?.first_name} {thisUser?.last_name}</h2>
          <p>{thisUser?.email}</p></div>
          <div className='m-5 mt-0 d-flex justify-content-between '>
            <div >
              
              {designCv.item?.expirience?.map((obj)=>{return(
              <div  className='border p-5 m-2 border-brown  border-5'>
                <h3 className='cv-highlight-brown'>Expirience</h3>
            ...
            {designCv.item?.educations?.map((obj)=>{return(
              <div className='border p-5 m-2  border-brown border-5' ><h3 className='cv-highlight-brown'>Education</h3>
