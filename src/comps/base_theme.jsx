...
import '../comp_css_theme/base_theme.css'
import { AppContext } from './context/context'
import html2pdf from 'html2pdf.js';


const Theme_base = (props) => {
  ...
  return (
    <>
      <div className="cv-container-base"  id='myDiv'>
        <div className="cv-section-base  text-justify-start">
          <div className='m-5 mt-0 d-flex justify-content-center '>
            <div >
              ...
              <h3  className='cv-title-base'> Expirience</h3>
              <p>{obj.company}</p>
            ...
            {designCv.item?.educations?.map((obj)=>{return(
              <div className='border p-5 m-2  border-brown border-5'>
              <h3 className='cv-title-base'>Education</h3>
              <p>{obj.subject}</p>
              <p>{obj.time_frame_end}</p>
              <p>{obj.time_frame_start}</p>
              </div>
          ...
          <h2 className="cv-title-bse">{thisUser?.first_name} {thisUser?.last_name}</h2>
